...
**Anno Accademico:** 2025/2026 **Repository:** [GitHub Link](https://github.com/eneamanzi/k8s-kafka-kong)

[**1\. Scenario e Obiettivi Architetturali	1**](#1.-scenario-e-obiettivi-architetturali)

[**2\. Architettura del Sistema	1**](#2.-architettura-del-sistema)

[**3\. Apache Kafka: il Core Event Streaming	2**](#3.-apache-kafka:-il-core-event-streaming)

[**4\. Kong API Gateway: Edge Computing & Security	2**](#4.-kong-api-gateway:-edge-computing-&-security)

[**5\. MongoDB: Persistenza e Ottimizzazione Dati	3**](#5.-mongodb:-persistenza-e-ottimizzazione-dati)

[**6\. Analisi delle Proprietà Non Funzionali (NFP)	3**](#6.-analisi-delle-proprietà-non-funzionali-\(nfp\))

[**7\. Sfide Tecniche e Soluzioni	5**](#7.-sfide-tecniche-e-soluzioni)

[**8\. Conclusioni e Raggiungimento Obiettivi	5**](#8.-conclusioni-e-raggiungimento-obiettivi)
...
La [pipeline *(qui l’immagine)*](https://github.com/eneamanzi/k8s-kafka-kong/blob/main/iot-kubernetes-architecture.svg) è progettata per gestire picchi di carico e garantire resilienza tramite meccanismi di *Backpressure*:
...
Kong gestisce il routing basato su Host (es. [`producer.nip.io`](http://producer.nip.io)) tramite **Ingress** e instrada il traffico verso i *Service* Kubernetes sottostanti. Il bilanciamento del carico tra le varie repliche dei pod applicativi avviene automaticamente sfruttando il meccanismo nativo dei Service, garantendo una distribuzione uniforme delle richieste.
